...
output "this_discord_topic_arn" {
  description = "The ARN of the SNS topic from which messages will be sent to discord (backward compatibility for version 4.x)"
  value       = local.sns_topic_arn
}
...
output "notify_discord_lambda_function_invoke_arn" {
  description = "The ARN to be used for invoking Lambda function from API Gateway"
  value       = module.lambda.lambda_function_invoke_arn
}

output "notify_discord_lambda_function_last_modified" {
  description = "The date Lambda function was last modified"
  value       = module.lambda.lambda_function_last_modified
}

output "notify_discord_lambda_function_version" {
